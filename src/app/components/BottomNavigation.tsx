...
export default function BottomNavigation({
  ...
  return (
    <div className="bg-white border-t border-[#E5E7EB] pb-2 pt-1.5 relative" style={{ boxShadow: '0 -2px 10px rgba(0,0,0,0.04)', display: 'grid', gridTemplateColumns: '0.58fr 0.68fr 1.8fr 0.68fr 0.58fr' }}>
      {tabs.map((tab) => {
        // Center FAB button
        if (tab.id === null) {
          return (
